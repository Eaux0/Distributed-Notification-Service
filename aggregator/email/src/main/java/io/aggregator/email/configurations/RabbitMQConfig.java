package io.aggregator.email.configurations;
...
public class RabbitMQConfig {
    ...
    public static final String MAIN_QUEUE = "notification.email.priority.queue";
    public static final String MAIN_EXCHANGE = "notification.email.exchange";
    public static final String MAIN_ROUTING_KEY = "notification.email";

    public static final String DLQ_QUEUE = "notification.email.dlq";
    public static final String DLQ_EXCHANGE = "notification.email.dlx";
